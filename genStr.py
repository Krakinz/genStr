...
PHONE_NUMBER_TEXT = (
    ...
    " include Country code. eg. +254718241545`\n\n"
    "Press /cancel to Cancel."
)
...
(C) Author: [Krakinz](https://t.me/krakinz) and \
[Krakinzlab](https://t.me/krakinzlab)
Give a Star ⭐️ to [REPO](https://github.com/Krakinz/genStr) if you like this Bot.
"""
